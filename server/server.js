...
functio requestHandler(request, response) {
	...
	fs.exists(requestedResource, function(exists) {
		// check if the file doesn't exists and return a 404 status (File not found)
		if(!exists) {
		...
		// Check if the requested resource is a directory. If it is, justset our
...
// create an instance of our httpServer and passingin our request handler callback
